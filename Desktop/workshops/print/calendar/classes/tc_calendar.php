...
class tc_calendar{
	...
	function writeCalendarContainer(){
		...
		echo("<div id=\"div_".$this->objname."\" style=\"position:".$div_position.";visibility:".$div_display.";".$div_align."\" class=\"div_calendar calendar-border\">"); //z-index:100;
		echo("<IFRAME id=\"".$this->objname."_frame\" src=\"".$this->path."calendar_form.php".$paramStr."\" frameBorder=\"0\" scrolling=\"no\" allowtransparency=\"true\" width=\"100%\" height=\"100%\" ></IFRAME>"); //style=\"z-index: 100;\"
